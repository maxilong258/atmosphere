...
import { Eye, EyeClosed, Pause, Play, SlidersHorizontal, Volume2 } from "lucide-react";
    ...
    <Drawer open={isSheetOpen} onOpenChange={changeOpen}>
      <DrawerTrigger asChild>
        <Button variant="ghost" size="icon">
          <SlidersHorizontal className="h-[1.5rem] w-[1.3rem] text-gray-300" />
        </Button>
      </DrawerTrigger>
      <DrawerContent
      ...
      >
        ...
        <div className="mx-auto w-full overflow-y-scroll flex justify-center">
          ...
          <span className="text-2xl text-white font-bold m-3 block">Rain</span>
          ...
          <span className="text-2xl text-white font-bold m-3 block">Room</span>
          ...
          <span className="text-2xl text-white font-bold m-3 block">City</span>
